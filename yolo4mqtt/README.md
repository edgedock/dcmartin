...
[![](https://images.microbadger.com/badges/image/dcmartin/amd64_yolo4mqtt-beta.svg)](https://microbadger.com/images/dcmartin/amd64_yolo4mqtt-beta "Get your own image badge on microbadger.com")
[![](https://images.microbadger.com/badges/version/dcmartin/amd64_yolo4mqtt-beta.svg)](https://microbadger.com/images/dcmartin/amd64_yolo4mqtt-beta "Get your own version badge on microbadger.com")
[![Docker Pulls][pulls-amd64]][docker-amd64]

[docker-amd64]: https://hub.docker.com/r/dcmartin/amd64_yolo4mqtt-beta
[pulls-amd64]: https://img.shields.io/docker/pulls/dcmartin/amd64_yolo4mqtt-beta.svg

![Supports armhf Architecture][arm-shield]
[![](https://images.microbadger.com/badges/image/dcmartin/arm_yolo4mqtt-beta.svg)](https://microbadger.com/images/dcmartin/arm_yolo4mqtt-beta "Get your own image badge on microbadger.com")
[![](https://images.microbadger.com/badges/version/dcmartin/arm_yolo4mqtt-beta.svg)](https://microbadger.com/images/dcmartin/arm_yolo4mqtt-beta "Get your own version badge on microbadger.com")
[![Docker Pulls][pulls-arm]][docker-arm]

[docker-arm]: https://hub.docker.com/r/dcmartin/arm_yolo4mqtt-beta
[pulls-arm]: https://img.shields.io/docker/pulls/dcmartin/arm_yolo4mqtt-beta.svg

![Supports aarch64 Architecture][arm64-shield]
[![](https://images.microbadger.com/badges/image/dcmartin/arm64_yolo4mqtt-beta.svg)](https://microbadger.com/images/dcmartin/arm64_yolo4mqtt-beta "Get your own image badge on microbadger.com")
[![](https://images.microbadger.com/badges/version/dcmartin/arm64_yolo4mqtt-beta.svg)](https://microbadger.com/images/dcmartin/arm64_yolo4mqtt-beta "Get your own version badge on microbadger.com")
[![Docker Pulls][pulls-arm64]][docker-arm64]

[docker-arm64]: https://hub.docker.com/r/dcmartin/arm64_yolo4mqtt-beta
[pulls-arm64]: https://img.shields.io/docker/pulls/dcmartin/arm64_yolo4mqtt-beta.svg
...
+ `url` - `com.github.dcmartin.open-horizon.yolo4mqtt`
+ `version` - `0.0.1`
...
Copy this [repository][repository], change to the `yolo4mqtt` directory, then use the **make** command; see below:

```
% mkdir ~/gitdir
% cd ~/gitdir
% git clone http://github.com/dcmartin/open-horizon
% cd open-horizon/yolo4mqtt
% make
...
{
  ...
  "org": "dcmartin@us.ibm.com",
  "pattern": "yolo4mqtt",
  "device": "test-cpu-2-arm_yolo4mqtt",
  "pid": 9,
  "yolo4mqtt": {
    "log_level": "info",
    "debug": "false",
...
```
The `yolo4mqtt` payload will be incomplete until the service completes; subsequent `make check` will return complete; see below:
```
{
  "hostname": "abec6ffa6455-172017000002",
  "org": "dcmartin@us.ibm.com",
...
[userinput]: https://github.com/dcmartin/open-horizon/blob/master/yolo4mqtt/userinput.json
[service-json]: https://github.com/dcmartin/open-horizon/blob/master/yolo4mqtt/service.json
[build-json]: https://github.com/dcmartin/open-horizon/blob/master/yolo4mqtt/build.json
[dockerfile]: https://github.com/dcmartin/open-horizon/blob/master/yolo4mqtt/Dockerfile
